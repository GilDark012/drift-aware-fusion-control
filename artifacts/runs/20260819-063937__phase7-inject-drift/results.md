# Run `20260819-063937__phase7-inject-drift`

- **Task**: phase7-inject-drift
- **Status**: completed
- **Started**: 2026-08-19T06:39:37.397389+00:00
- **Duration**: 19.99 s
...
| detection_rate | all | 0 | 0.045 |  | sudden |
| false_alarm_rate | all | 0 | 0.01 |  | sudden |
| median_detection_latency | all | 0 | 5.0 | interactions | sudden |
| injected_users | all | 0 | 300.0 | users | gradual |
| detection_rate | all | 0 | 0.04 |  | gradual |
| false_alarm_rate | all | 0 | 0.01 |  | gradual |
| median_detection_latency | all | 0 | 12.0 | interactions | gradual |
| injected_users | all | 0 | 300.0 | users | recurring |
| detection_rate | all | 0 | 0.05 |  | recurring |
| false_alarm_rate | all | 0 | 0.01 |  | recurring |
| median_detection_latency | all | 0 | 7.5 | interactions | recurring |

## Findings

- sudden: detection_rate=0.04, median_latency=5, false_alarm=2/200
- gradual: detection_rate=0.04, median_latency=12, false_alarm=2/200
- recurring: detection_rate=0.05, median_latency=8, false_alarm=2/200
