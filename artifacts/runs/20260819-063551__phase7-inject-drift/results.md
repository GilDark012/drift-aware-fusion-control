# Run `20260819-063551__phase7-inject-drift`

- **Task**: phase7-inject-drift
- **Status**: completed
- **Started**: 2026-08-19T06:35:51.991588+00:00
- **Duration**: 20.99 s
...
| median_detection_latency | all | 0 | 7.0 | interactions | sudden |
| injected_users | all | 0 | 300.0 | users | gradual |
| detection_rate | all | 0 | 0.02 |  | gradual |
| false_alarm_rate | all | 0 | 0.0 |  | gradual |
| median_detection_latency | all | 0 | 13.5 | interactions | gradual |
| injected_users | all | 0 | 300.0 | users | recurring |
| detection_rate | all | 0 | 0.025 |  | recurring |
| false_alarm_rate | all | 0 | 0.0 |  | recurring |
| median_detection_latency | all | 0 | 6.0 | interactions | recurring |

## Findings

- sudden: detection_rate=0.04, median_latency=7, false_alarm=0/200
- gradual: detection_rate=0.02, median_latency=14, false_alarm=0/200
- recurring: detection_rate=0.03, median_latency=6, false_alarm=0/200
